function SeqBat_Waterfall(flightPaths34,bat)

% Function to make waterfall plots 

% Get the in-order flight clusters
[ss_1,rr_1] = sort(flightPaths34.flight_starts_idx);
c_s_34 = flightPaths34.id(rr_1);
days = flightPaths34.day(rr_1);
flight_takeoffs = flightPaths34.flight_starts_idx(rr_1);
...
for i=1:co
    ...
    figure('name',strcat(bat,';',num2str(i))); hold on; title(strcat("Waterfall plot cluster"," ",num2str(i)));
